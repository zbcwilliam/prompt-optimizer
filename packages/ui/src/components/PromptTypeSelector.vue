  ...
  <div class="prompt-type-selector">
    <div class="flex items-center gap-2">
      <span class="text-xs text-gray-500 dark:text-gray-400">
        {{ t('promptOptimizer.promptType') }}:
      </span>
      <div class="inline-flex bg-gray-50 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-600 text-xs">
        <button
          @click="updatePromptType('system')"
          :class="[
            'px-2 py-1 transition-colors duration-150 rounded-l',
        ...
        <button
          ...
          :class="[
            'px-2 py-1 transition-colors duration-150 rounded-r',
            'focus:outline-none focus:ring-1 focus:ring-blue-400',
            modelValue === 'user'
              ? 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
              : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-75 dark:hover:bg-gray-750'
